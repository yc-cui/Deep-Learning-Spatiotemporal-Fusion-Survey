...
from LibSTFv1.model.SRSF_GAN.SRSF_GAN import SRSFGANModel
...
def main(args):
    ...
    model_name = "STF." + SRSFGANModel.__name__
    ...
    #trainer.test(model, ckpt_path="log/BC/SRSFGAN/log_m=STF.SRSFGANModel_sd=45_d=BC/ep=29_PSNR=21.7633.ckpt", datamodule=dataset)
