...
from LibSTFv1.model.ECPW_STFN.ECPW_STFN import ECPW_STFNModel
...
def get_args_parser():
    ...
    parser.add_argument('--dataset', default="AHB", choices=["CIA", "LGC", "AHB", "DX", "TJ", "WH", "IC", "BC"], type=str)
    parser.add_argument('--test_freq', default=10, type=int) #test
...
def main(args):
    ...
    model_name = "STF." + ECPW_STFNModel.__name__
    ...
    trainer.test(model, ckpt_path="log/AHB/ECPW_STFN/log_m=STF.ECPW_STFNModel_sd=42_d=AHB/ep=9_PSNR=27.3314.ckpt", datamodule=dataset)
