...
from LibSTFv1.model.SwinSTFM.SwinSTFM import SwinSTFMModel
...
def main(args):
    ...
    model_name = "STF." + SwinSTFMModel.__name__
    ...
    #trainer.test(model, ckpt_path="log/WH/SwinSTFM/log_m=STF.SwinSTFMModel_sd=46_d=WH/ep=209_PSNR=26.5141.ckpt", datamodule=dataset)
