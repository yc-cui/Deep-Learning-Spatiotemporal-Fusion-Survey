...
from LibSTFv1.model.GAN_STFM.GAN_STFM import GANSTFMModel
...
def main(args):
    ...
    model_name = "STF." + GANSTFMModel.__name__
    ...
    #trainer.test(model, ckpt_path="log/WH/GAN_STFM/log_m=STF.GANSTFMModel_sd=42_d=WH/ep=19_PSNR=27.3631.ckpt", datamodule=dataset)
