...
from LibSTFv1.model.MLFF_GAN.MLFF_GAN import MLFFGANModel
...
def get_args_parser():
    ...
    parser.add_argument('--dataset', default="BC", choices=["CIA", "LGC", "AHB", "DX", "TJ", "WH", "IC", "BC"], type=str)
...
def main(args):
    ...
    model_name = "STF." + MLFFGANModel.__name__
    ...
    trainer.test(model, ckpt_path="log/BC/MLFFGAN/log_m=STF.MLFFGANModel_sd=46_d=BC/ep=299_PSNR=26.1352.ckpt", datamodule=dataset)
