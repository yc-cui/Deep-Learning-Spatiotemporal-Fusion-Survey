...
from LibSTFv1.model.EDCSTFN.EDCSTFN import EDCSTFNModel
...
def main(args):
    ...
    model_name = "STF." + EDCSTFNModel.__name__
    ...
    trainer.test(model, ckpt_path="log/WH/EDC_STFN/log_m=STF.EDCSTFNModel_sd=46_d=WH/ep=139_PSNR=29.0801.ckpt", datamodule=dataset)
